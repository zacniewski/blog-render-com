...
This is a simple Django-based blog application that includes a custom history tracking system. It is designed to be easily deployable on [Render](htpps://render.com) platform.  
...
- `render.yaml`: Configuration for deployment of the Django project on [Render](https://render.com/docs/deploy-django).
